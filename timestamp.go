...
var printVersion = flag.Bool("V", false,
...
func main() {
	...
	if *printVersion {
		...
		fmt.Printf("%s built with %s%s\n", version, runtime.Version(), date)
		os.Exit(0)
	}
	...
	switch *precision {
	case "day":
		divisor = int64(24 * 60 * 60 * 1000 * 1000 * 1000)
	case "hour":
		divisor = int64(60 * 60 * 1000 * 1000 * 1000)
	case "minute":
		divisor = int64(60 * 1000 * 1000 * 1000)
	case "min":
		divisor = int64(60 * 1000 * 1000 * 1000)
	case "second":
		divisor = int64(1000 * 1000 * 1000)
	case "sec":
		divisor = int64(1000 * 1000 * 1000)
	case "s":
		divisor = int64(1000 * 1000 * 1000)
	case "ms":
		divisor = int64(1000 * 1000)
	case "us":
		divisor = int64(1000)
	case "µs":
		divisor = int64(1000)
